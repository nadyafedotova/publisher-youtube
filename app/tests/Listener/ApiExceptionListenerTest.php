...
class ApiExceptionListenerTest extends AbstractTestCase
{
    ...
    {
        $responseMessage = json_encode(Response::HTTP_INTERNAL_SERVER_ERROR);
        $responseBody = json_encode(['errors' => $responseMessage]);
    ...
    private function assertResponse(int $statusCode, string $responseBody, Response $response): void
    {
